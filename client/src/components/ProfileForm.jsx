...
const ProfileForm = ({ initialData, onSuccess }) => {
     ...
     return (
          <form onSubmit={handleSubmit} className="card p-5 sm:p-6 mb-6">
               ...
               {
                    error && (
                         <div className='bg-rose-50 text-rose-700 p-4 rounded-xl tex-sm border border-rose-200 mb-6 flex items-start gap-3'>
               ...
               <div className='space-y-5'>
                    ...
                    </div>
                    {
                         initialData.isDeleted ? (
                              <div className='pt-2'>
                                   <div>
                                        <p className='text-rose-600 font-medium tracking-tight'>Account Deactiveted</p>
