...
const ApplyModelLeave = ({ open, onClose, onSuccess }) => {
                    ...
                    >
                         ...
                         <div>
                              ...
                              <div className='flex gap-3 pt-2'>
                                   <button onClick={onClose} type='button' className='btn-secondary flex-1'>Cancle</button>
...
export default ApplyModelLeave